						...
						<tr>
							<th>
								<c:choose>
									...
									<c:otherwise>
										<img  style="width: 150px; height: 150px;" src="${pageContext.request.contextPath }/resources/img/undraw_profile.svg">
									</c:otherwise>
								</c:choose>
							...
							<td>
								아이디: ${sessionScope.loginInfo.mid}
								<br>
								이름: ${sessionScope.loginInfo.mname}
								<br>
