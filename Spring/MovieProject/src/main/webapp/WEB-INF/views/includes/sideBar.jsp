...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="${pageContext.request.contextPath }/">
		<div class="sidebar-brand-text mx-3">Movie reservation</div>
	</a>
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseSocket" aria-expanded="true" aria-controls="collapseSocket">
			<span>Test</span>
		</a>
		<div id="collapseSocket" class="collapse" aria-labelledby="headingSocket" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
